...
export function PatientsImportDialog({ open, onOpenChange }: Props) {
    ...
    >
      <DialogContent className='sm:max-w-sm gap-2'>
        <DialogHeader className='text-left'>
          ...
          <DialogDescription>
            Import patients quickly from a CSV file.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
          <form id='patient-import-form' onSubmit={form.handleSubmit(onSubmit)}>
            <FormField
        ...
        <DialogFooter className='gap-2 sm:gap-0'>
          ...
          <Button type='submit' form='patient-import-form'>
            Import
          </Button>
        </DialogFooter>
      </DialogContent>
